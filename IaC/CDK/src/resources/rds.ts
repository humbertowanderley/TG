...
import { Credentials, DatabaseInstance, DatabaseInstanceEngine, DatabaseInstanceFromSnapshot, IDatabaseInstance, MariaDbEngineVersion } from "@aws-cdk/aws-rds";
...
export class RDS {
    ...
    public static createRDS(resourcesStack: ResourcesStack) {
        ...
        this.dbInstance = new DatabaseInstanceFromSnapshot(resourcesStack, 'db-instance', {
